...
[**#Analysis:**]{style="color:red"}
**There are 190 support vectors, or roughly 30% of the total data points.
...
[**#Analysis:**]{style="color:red"}
**With increasing C, we weight the cost function more towards misclassification (realtive to margin). Therefore intuitively incereasing C, should increase Accuracy albeit at the cost of margin. And in the above data points too, similar effect is apparent**
