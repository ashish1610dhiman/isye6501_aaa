...
```
## Observations: 
Wealth and Income Inequality are 2 highly correlated variables (-ve correlation) ,hence we can 1 variable out of both
...
```{r}
# removing all the potential outliers/influential points
crime_data_wo<-crime_data[-c(11,46,29),]
dim(crime_data_wo)
